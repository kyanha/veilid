...
// Generated by `flutter_rust_bridge`.
        ...
        // Section: wire functions
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "startup_veilid_core", port: Some(port_), mode: FfiCallMode::Stream }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "get_veilid_state", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| get_veilid_state()
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "change_api_log_level", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "shutdown_veilid_core", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| shutdown_veilid_core()
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "veilid_version_string", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| veilid_version_string()
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "veilid_version", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| veilid_version()
...
impl NewWithNullPtr for wire_VeilidConfig {
                    fn new_with_null_ptr() -> Self {
                        Self { program_name: core::ptr::null_mut(),
...
impl support::IntoDart for VeilidUpdate {
                fn into_dart(self) -> support::DartCObject {
                    match self {
                        Self::Log{log_level,message} => vec![0.into_dart(),log_level.into_dart(),message.into_dart()],
